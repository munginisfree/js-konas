describe('Spread syntax에 대해 학습합니다.', function () {
  ...
  it('Rest Parameter는 함수의 전달인자를 배열로 다룰 수 있게 합니다.', function () {
    ...
    //if the key of object is number type then the argument should be object[`0`]
    ...
    expect(restParams === argumentsObj).to.deep.equal(false); //restParams: array. argumentsObj: object
    ...
    const argsArr = Array.from(argumentsObj); //change object to array
